...
- main [ref=e2]:
  - generic [ref=e4]:
    ...
    - generic [ref=e24]:
      - checkbox "Toggle todo" [ref=e25] [cursor=pointer]
      - generic [ref=e26]: Delete me
      - generic [ref=e27]:
        - button "Edit todo" [ref=e28] [cursor=pointer]: Edit
        - button "Delete todo" [ref=e29] [cursor=pointer]: Delete
    - generic [ref=e30]:
      - button "Clear Completed" [disabled] [ref=e31]
      - button "Clear All" [ref=e32] [cursor=pointer]
    - generic [ref=e33]: "Lab 9: The final battle!"
```